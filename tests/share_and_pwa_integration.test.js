...
// Check Trataka module integration
assert(pageSource.includes('<TratakaModule'), 'page.tsx must mount TratakaModule');
console.log('  ✓ Clinical Trataka module integration verified');
